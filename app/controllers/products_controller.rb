  ...
  private
    ...
    def product_params
      clean_params = params.require(:product).permit(
        ...
        external_image_urls: [],
        category_ids: [],
        variants_attributes: [:id, :sku, :ean, :price, :cost_price, :discount_price, :promo_active, :stock, :vat_rate, :status, :height, :width, :depth, :weight, :description_title, :description, :external_image_url, :_destroy, option_value_ids: [], external_image_urls: []]
      )
